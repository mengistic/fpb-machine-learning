...
\newfontfamily{\englishfamily}{TeX Gyre Pagella}[Ligatures=TeX, Scale=1]
\newfontfamily{\jetbrainsfamily}{Noto Sans} % Noto Sans
\newfontfamily{\monofamily}[Scale=1.2]{Latin Modern Mono}


%% declare Khmer and Engish fonts
...
%% declare another English
%% fonts (needs it's font family)
\newrobustcmd{\mono}{
